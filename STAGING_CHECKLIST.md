...
- [ ] `render.yaml` commitato e pushato su GitHub
...
- [ ] Blueprint applicato su Render Dashboard
- [ ] Secrets compilati nel Dashboard (`NP_LICENSE_PRIVATE_KEY_B64`, `NP_LICENSE_KEYS`)
...
- [ ] Audit log visibile nei log Render (AUDIT ACTIVATE_OK / ACTIVATE_FAIL)
...
- [ ] `license_server_url` punta a URL staging Render
